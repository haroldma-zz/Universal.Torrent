namespace Universal.Torrent.Common.EventArgs
{
    public class TorrentCreatorEventArgs : System.EventArgs
    {
        #region Constructors
        ...
        /// </summary>
        public double FileCompletion => FileBytesHashed/(double) FileSize*100.0;
        ...
        /// </summary>
        public double OverallCompletion => OverallBytesHashed/(double) OverallSize*100.0;
